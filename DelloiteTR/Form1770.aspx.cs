...
{
    public partial class Form1770 : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f14))
                {
                    t1s8f14.Value = vmTaxForm.t1s8f14.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f15))
                {
                    t1s8f15.Value = vmTaxForm.t1s8f15.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f16))
                {
                    t1s8f16.Value = vmTaxForm.t1s8f16.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f17))
                {
                    t1s8f17.Value = vmTaxForm.t1s8f17.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f18))
                {
                    t1s8f18.Value = vmTaxForm.t1s8f18.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f19))
                {
                    t1s8f19.Value = vmTaxForm.t1s8f19.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f20))
                {
                    t1s8f20.Value = vmTaxForm.t1s8f20.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f21))
                {
                    t1s8f21.Value = vmTaxForm.t1s8f21.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f22))
                {
                    t1s8f22.Value = vmTaxForm.t1s8f22.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f23))
                {
                    t1s8f23.Value = vmTaxForm.t1s8f23.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f24))
                {
                    t1s8f24.Value = vmTaxForm.t1s8f24.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f25))
                {
                    t1s8f25.Value = vmTaxForm.t1s8f25.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f26))
                {
                    t1s8f26.Value = vmTaxForm.t1s8f26.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f27))
                {
                    t1s8f27.Value = vmTaxForm.t1s8f27.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f28))
                {
                    t1s8f28.Value = vmTaxForm.t1s8f28.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f29))
                {
                    t1s8f29.Value = vmTaxForm.t1s8f29.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f30))
                {
                    t1s8f30.Value = vmTaxForm.t1s8f30.ToString().Split('.')[0];
                }
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f31))
                {
                    t1s8f31.Value = vmTaxForm.t1s8f31.ToString().Split('.')[0];
                }

                t1s8f32.Checked = Convert.ToBoolean(vmTaxForm.t1s8f32);
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f33))
                {
                    t1s8f33.Value = vmTaxForm.t1s8f33.ToString().Split('.')[0];
                }
                t1s8f34.Text = vmTaxForm.t1s8f34;
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f35))
                {
                    t1s8f35.Value = vmTaxForm.t1s8f35.ToString().Split('.')[0];
                }
                t1s8f36.Text = vmTaxForm.t1s8f36;
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f37))
                {
                    t1s8f37.Value = vmTaxForm.t1s8f37.ToString().Split('.')[0];
                }
                t1s8f38.Text = vmTaxForm.t1s8f38;
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f39))
                {
                    t1s8f39.Value = vmTaxForm.t1s8f39.ToString().Split('.')[0];
                }
                t1s8f40.Text = vmTaxForm.t1s8f40;
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f41))
                {
                    t1s8f41.Value = vmTaxForm.t1s8f41.ToString().Split('.')[0];
                }
                t1s8f42.Text = vmTaxForm.t1s8f42;
                if (!string.IsNullOrEmpty(vmTaxForm.t1s8f43))
                {
                    t1s8f43.Value = vmTaxForm.t1s8f43.ToString().Split('.')[0];
                }
                //finish-form1-8====================
